...
class JSSDK {
  ...
  public function __construct($appId, $appSecret) {
    ...
    // TODO: modify online
    $this->jsapi_ticket_file = './cache/jsapi_ticket.json';
    $this->access_token_file = './cache/access_token.json';
    // $this->jsapi_ticket_file = '/web/wx/jsapi_ticket.json';
    // $this->access_token_file = '/web/wx/access_token.json';
  }
